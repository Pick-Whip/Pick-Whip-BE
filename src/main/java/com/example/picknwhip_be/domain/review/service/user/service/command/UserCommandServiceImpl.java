...
import com.example.picknwhip_be.domain.review.service.user.exception.UserException;
import com.example.picknwhip_be.domain.review.service.user.exception.code.UserErrorCode;
import com.example.picknwhip_be.domain.review.service.user.repository.UserRepository;
import com.example.picknwhip_be.domain.review.service.user.repository.UserWithdrawalRepository;
import com.example.picknwhip_be.domain.review.service.user.repository.WithdrawalReasonItemRepository;
...
public class UserCommandServiceImpl implements UserCommandService {
  ...
  @Override
  public void updateExtraInfo(Long userId, UserReqDTO.ExtraInfoDTO request) {
    User user =
        userRepository
            .findById(userId)
  ...
  @Override
  public User updateProfile(Long userId, UserReqDTO.UpdateProfileDTO request) {
    User user =
        userRepository
            .findById(userId)
            .orElseThrow(() -> new UserException(UserErrorCode.USER_NOT_FOUND));
