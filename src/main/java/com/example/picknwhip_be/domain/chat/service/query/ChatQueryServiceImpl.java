...
public class ChatQueryServiceImpl implements ChatQueryService {
  ...
  @Override
  public ChatResDTO.MessageListDTO getMessages(Long roomId, Long cursor, Integer size) {
    ...
    List<ChatResDTO.MessageInfo> messageInfos =
  ...
  @Override
  public ChatResDTO.ChatRoomListDTO getChatRoomList(
    ...
    List<ChatResDTO.ChatRoomSummaryDTO> summaryList =
        rooms.stream()
            .map(
                room -> {
