...
public class FavoriteDesignService {
  ...
  public FavoriteDesignResponseDTO addFavoriteDesign(Long designId, Long userId) {
    ...
    return new FavoriteDesignResponseDTO(designId, true);
  }

  public FavoriteDesignResponseDTO deleteFavoriteDesign(Long designId, Long userId) {
    ...
    return new FavoriteDesignResponseDTO(designId, false);
  }
}
