...
public interface OrderRepository extends JpaRepository<Order, Long> {
    ...
    @Query("SELECT o.pickupDatetime, COUNT(o) FROM Order o " +
            "WHERE o.shop.id = :shopId " +
            "AND FUNCTION('DATE', o.pickupDatetime) = :date " +
            "AND o.status != 'IMPOSSIBLE' " + // 취소/거절된 주문은 제외
            "GROUP BY o.pickupDatetime")
    List<Object[]> countOrdersByShopAndDate(@Param("shopId") Long shopId, @Param("date") LocalDate date);
}
