...
class PickupTimeValidatorTest {
    ...
    void validate_ShouldUseKST_WhenServerIsUTC() {
        ...
        PickupTimeValidator validator = new PickupTimeValidator(
                businessHourRepository, orderRepository, kstClock
        );
        ...
        // 추가로 에러 코드 검증: .hasFieldOrPropertyWithValue("errorCode", OrderErrorCode.INVALID_PICKUP_TIME) 등으로 상세 검증 가능
    }
}