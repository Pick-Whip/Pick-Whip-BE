...
class PopularCakeRankingSchedulerTest {
    ...
    @InjectMocks
    private PopularCakeRankingScheduler scheduler;
    ...
    void refreshTop5_Success() {
        ...
        given(paymentRepository.findPopularCakesTop5(any(LocalDateTime.class), any(LocalDateTime.class)))
        ...
        // 새로운 데이터 저장 확인 (ArgumentCaptor로 저장된 값 검증)
